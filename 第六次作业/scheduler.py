...
class MinimalScheduler(Scheduler):
    ...
    def resourceOffers(self, driver, offers):
        ...
        for offer in offers:
        	...
        	ip = Dict()
        	ip.key = 'ip'
        	ip.value = '192.168.0.10' + str((int)self.launched_task)
        	...
        	volume1 = Dict()
        	volume1.key = 'volume'
        	volume1.value = '/home/pkusei/hw6_gluster/ssh_info:/ssh_info'

        	# volume2
        	volume2 = Dict()
        	volume2.key = 'volume'
        	volume2.value = '/home/pkusei/hw6_gluster/data:/home/admin/shared_folder'
        	...
        	task = Dict()
        	task_id = 'node' + str((int)self.launched_task)
